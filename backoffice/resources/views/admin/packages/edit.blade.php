                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <select
                                ...
                                required
                            >
                                <option value="month" {{ old('period', $package->period) == 'month' ? 'selected' : '' }}>Monthly</option>
                                <option value="year" {{ old('period', $package->period) == 'year' ? 'selected' : '' }}>Yearly</option>
                            </select>
                            @error('period')
                                <span class="invalid-feedback" role="alert">{{ $message }}</span>
                            @enderror
                        ...
                        <div class="form-group">
                            <div class="form-check">
                                ...
                                <input
                                    ...
                                    id="popular"
                                    value="1"
                                    {{ old('popular', $package->popular) ? 'checked' : '' }}
                                >
