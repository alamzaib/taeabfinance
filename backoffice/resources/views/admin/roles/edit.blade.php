                                                    ...
                                                    @if(isset($moduleData['permissions']['read']))
                                                        <div class="form-check">
                                                            <input
                                                                ...
                                                                data-module="{{ $module }}"
                                                                {{ $role->permissions->contains($moduleData['permissions']['read']['permission']->id) ? 'checked' : '' }}
                                                            >
                                                    ...
                                                    @if(isset($moduleData['permissions']['write']))
                                                        <div class="form-check">
                                                            <input
                                                                ...
                                                                data-module="{{ $module }}"
                                                                {{ $role->permissions->contains($moduleData['permissions']['write']['permission']->id) ? 'checked' : '' }}
                                                            >
                                                    ...
                                                    @if(isset($moduleData['permissions']['update']))
                                                        <div class="form-check">
                                                            <input
                                                                ...
                                                                data-module="{{ $module }}"
                                                                {{ $role->permissions->contains($moduleData['permissions']['update']['permission']->id) ? 'checked' : '' }}
                                                            >
                                                    ...
                                                    @if(isset($moduleData['permissions']['delete']))
                                                        <div class="form-check">
                                                            <input
                                                                ...
                                                                data-module="{{ $module }}"
                                                                {{ $role->permissions->contains($moduleData['permissions']['delete']['permission']->id) ? 'checked' : '' }}
                                                            >
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('.module-select-all').each(function() {
                const module = $(this).data('module');
                const moduleCheckboxes = $(`.permission-checkbox[data-module="${module}"]`);
                const allChecked = moduleCheckboxes.length > 0 && moduleCheckboxes.length === moduleCheckboxes.filter(':checked').length;
